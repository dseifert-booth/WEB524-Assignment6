...
using System.Web;
using AutoMapper;
using F2022A6DSB.Data;
using F2022A6DSB.Models;

// ************************************************************************************
// WEB524 Project Template V3 == 2227-94ca2425-1222-422f-8ae7-807d3de77d8b
//
    ...
    public class Manager
    {
        ...
        public Manager()
        {
            ...
            var config = new MapperConfiguration(cfg =>
            {
                ...
                cfg.CreateMap<TrackBaseViewModel, TrackEditAudioFormViewModel>();

                cfg.CreateMap<MediaItem, Models.MediaItemBaseViewModel>();
                cfg.CreateMap<MediaItem, Models.MediaItemContentViewModel>();
        ...
        {
            // REMINDER -- May need Include()s, keep eye out
            var obj = ds.Artists.Include("Albums").SingleOrDefault(a => a.Id == id);

            var detailItem = mapper.Map<Artist, ArtistWithDetailViewModel>(obj);
            detailItem.NumAlbums = obj.Albums.Count;
        ...
        public AlbumWithDetailViewModel AlbumGetByIdWithDetail(int id)
        {
            ...
            var detailItem = mapper.Map<Album, AlbumWithDetailViewModel>(obj);
        ...
        /*public IEnumerable<TrackBaseViewModel> TrackGetAllByArtistId(int? id)
        {
            ...
            foreach (var album in artist.Albums) tracks.AddRange(album.Tracks);
        ...
        {
            // REMINDER -- May need Include()s, keep eye out
            var obj = ds.Tracks.Include("Albums").SingleOrDefault(t => t.Id == id);

            var detailItem = mapper.Map<Track, TrackWithDetailViewModel>(obj);
        ...
        public TrackWithDetailViewModel TrackAudioGetById(int id)
        {
            var o = ds.Tracks.Find(id);

            return (o == null) ? null : mapper.Map<Track, TrackWithDetailViewModel>(o);
        }

        public TrackWithDetailViewModel TrackEditAudio(TrackEditAudioViewModel track)
        {
            ...
            else
            {
                ...
                obj.Audio = audioBytes;
                obj.AudioContentType = track.AudioUpload.ContentType;
